...
<div id="sidebar">
	...
	<?php else : ?>
		<div id="primary-sidebar" class="primary-sidebar widget-area" role="complementary">
			...
			<aside id="sidebar-newsletter-signup" class="widget widget_archive">
				<h2 class="widget-title">Get Free Weekly Marketing Tips Straight In Your Inbox!</h2>
				...
				<p>
					<input id="sidebar-submit-button" type="submit" value="Send me the tips!" />
				</p>
			</aside>
